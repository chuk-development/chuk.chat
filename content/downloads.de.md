...
platforms:
  ...
  - name: "Windows"
    ...
    link: "https://github.com/chuk-development/chuk_chat/releases/latest/download/chuk_chat-windows-x64-setup.exe"
    button: "Setup herunterladen"
    disabled: false
    downloads:
      - label: "Setup.exe"
        link: "https://github.com/chuk-development/chuk_chat/releases/latest/download/chuk_chat-windows-x64-setup.exe"
      - label: "Portable ZIP"
        link: "https://github.com/chuk-development/chuk_chat/releases/latest/download/chuk_chat-windows-x64-portable.zip"
  - name: "Android"
    version: "Android 8.0+"
    ...
    link: "https://github.com/chuk-development/chuk_chat/releases/latest/download/chuk_chat-android-armv8.apk"
    ...
    downloads:
      - label: "ARMv8"
        link: "https://github.com/chuk-development/chuk_chat/releases/latest/download/chuk_chat-android-armv8.apk"
      - label: "ARMv7"
        link: "https://github.com/chuk-development/chuk_chat/releases/latest/download/chuk_chat-android-armv7.apk"
      - label: "x64"
        link: "https://github.com/chuk-development/chuk_chat/releases/latest/download/chuk_chat-android-x64.apk"
  - name: "Linux"
    ...
    link: "https://github.com/chuk-development/chuk_chat/releases/latest/download/chuk_chat-linux-amd64.deb"
    button: ".deb herunterladen"
    disabled: false
    downloads:
      - label: ".deb"
        link: "https://github.com/chuk-development/chuk_chat/releases/latest/download/chuk_chat-linux-amd64.deb"
      - label: ".rpm"
        link: "https://github.com/chuk-development/chuk_chat/releases/latest/download/chuk_chat-linux-x86_64.rpm"
      - label: ".AppImage"
        link: "https://github.com/chuk-development/chuk_chat/releases/latest/download/chuk_chat-linux-x86_64.AppImage"
  - name: "macOS"
    ...
    link: "https://github.com/chuk-development/chuk_chat/releases/latest/download/chuk_chat-macos.dmg"
    button: "DMG herunterladen"
    disabled: false
  - name: "iOS"
    version: "iOS 14+"
    icon: '<svg style="width: 40px; height: 40px; margin-bottom: 16px; color: var(--text-color);" viewBox="0 0 24 24" fill="currentColor"><path d="M17.3377 13.313C17.3637 11.047 19.2384 9.65865 19.3347 9.60265C18.192 7.94332 16.417 7.68265 15.8087 7.65599C14.302 7.49999 12.839 8.54399 12.069 8.54399C11.2904 8.54399 10.1057 7.67332 8.84235 7.69465C7.18902 7.71599 5.65368 8.65599 4.81368 10.1147C3.07568 13.1253 4.37302 17.5853 6.05302 20.0147C6.88368 21.204 7.85435 22.5347 9.16235 22.4867C10.425 22.4373 10.901 21.6827 12.4624 21.6827C14.0144 21.6827 14.4397 22.4867 15.7844 22.4613C17.1564 22.4133 18.0377 21.1893 18.851 19.996C19.8024 18.6053 20.2024 17.2547 20.2224 17.1747C20.205 17.1653 17.3037 16.056 17.3377 13.313ZM14.8984 5.74932C15.6037 4.89599 16.0784 3.70799 15.9477 2.53199C14.909 2.57599 13.6477 3.22532 12.893 4.08132C12.2144 4.84665 11.621 6.05999 11.7757 7.22265C12.9357 7.31332 14.1917 6.60399 14.8984 5.74932Z"/></svg>'
